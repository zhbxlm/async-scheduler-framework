...
class CronConfig:
    ...
    def __post_init__(self):
        self.enabled        = os.getenv("CRON_SCHEDULER_ENABLED", str(self.enabled)).lower() == "true"
...
class CallbackRetryConfig:
    ...
    def __post_init__(self):
        self.enabled            = os.getenv("CALLBACK_RETRY_ENABLED", str(self.enabled)).lower() == "true"
...
class ResourceGovernanceConfig:
    ...
    def __post_init__(self):
        self.enabled  = os.getenv("RESOURCE_GOVERNANCE_ENABLED", str(self.enabled)).lower() == "true"
...
class ReconcileConfig:
    ...
    def __post_init__(self):
        self.enabled                    = os.getenv("RECONCILE_ENABLED", str(self.enabled)).lower() == "true"
...
class RegistryTtlConfig:
    node_seconds: int = 604800       # 7 days
    schedule_seconds: int = 31536000 # 1 year
