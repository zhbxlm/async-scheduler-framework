...
class ExecutionLockConfig:
    ...
    def __post_init__(self):
        ...
        self.renew_interval_seconds = float(os.getenv("TASK_EXECUTION_LOCK_RENEW_INTERVAL_SECONDS", self.renew_interval_seconds))
...
class ConsumerConfig:
    ...
    def __post_init__(self):
        self.enabled                      = os.getenv("TASK_CONSUMER_ENABLED", str(self.enabled)).lower() == "true"
...
class TaskConfig:
    ...
    record_ttl_seconds: int = 2592000   # 30 days

    def __post_init__(self):
        self.persist_strict             = os.getenv("TASK_PERSIST_STRICT", str(self.persist_strict)).lower() == "true"
