"""task-api package-owned base Redis registry."""
...
from scheduler_task_api.error_handling import ExternalServiceError, log_errors
...
class BaseRedisRegistry(Generic[T]):
    def __init__(self, redis_client: aioredis.Redis, key_prefix: str, ttl_seconds: int = 0):
