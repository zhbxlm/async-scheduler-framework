"""BaseWorkerActor — aligned with docs/deepwiki-reference/Worker 开发.md

Template-method base class for Worker actors (Ray or plain Python).
...
class _BaseWorkerActorImpl:
    ...
    to produce the ``BaseWorkerActor`` alias.
    """
