"""Node domain models — aligned with docs/deepwiki-reference/数据模型.md"""
...
class NodeLease(BaseModel):
    """Node lease recorded in Redis."""
    node_id: str
    cluster_id: str
    tenant_id: str = ""
    leased_at: float = 0.0
    expires_at: float = 0.0
    state: NodeState = NodeState.RESERVED
